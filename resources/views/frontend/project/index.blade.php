    ...
    <section class="page-title"
        ...
        <div class="auto-container">
            <div class="sec-title">
                ...
                <div class="bread-crumb"><a href="{{ asset('/') }}">{{ __('Home') }}</a> / <a href="#" class="current">{{ __('Our Projects') }}</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="column blog-news-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <article class="inner-box">
                            ...
                            <div class="content-box">
                                <h4>
                                    <a href="{{ route('project.show', $project->slug) }}">{{ \Illuminate\Support\Str::limit($project->translate()->title, 80,'...') }}</a>
                                </h4>
                            </div>
                        </article>
                    </div>
